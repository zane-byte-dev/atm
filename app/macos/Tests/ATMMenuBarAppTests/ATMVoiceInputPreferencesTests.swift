...
final class ATMVoiceInputPreferencesTests: XCTestCase {
    ...
    func testVoiceAndLauncherShortcutsUseSeparateStorage() {
        XCTAssertNotEqual(ATMVoiceInputPreferences.hotKeyKey, ATMGlobalHotKeyPreferences.hotKeyKey)
        XCTAssertNotEqual(ATMVoiceInputPreferences.hotKeyEnabledKey, ATMGlobalHotKeyPreferences.enabledKey)
        XCTAssertNotEqual(ATMVoiceInputPreferences.defaultHotKey, ATMGlobalHotKeyPreferences.defaultHotKey)
