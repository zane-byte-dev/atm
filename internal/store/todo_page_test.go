...
func TestReadTodoPageBoundsRowsCountsProjectsAndDependencies(t *testing.T) {
	...
	if page.Counts["all"] != 3 || page.Counts["open"] != 2 || page.Counts["review"] != 1 || page.Counts["archived"] != 0 {
	...
	if err != nil || archived.Total != 1 || len(archived.Todos) != 1 || archived.Todos[0].ID != "t9" || archived.Counts["all"] != 3 {
