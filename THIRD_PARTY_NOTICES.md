...
Licensed under the Apache License, Version 2.0. A copy is included at [`LICENSES/Apache-2.0.txt`](LICENSES/Apache-2.0.txt).

Ping Island draws inspiration from claude-island by Farouq Aldori. The notices above are informational and do not modify the Apache License.
